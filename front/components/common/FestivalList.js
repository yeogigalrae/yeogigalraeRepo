...
// export default FestivalList = ({ data }) => {
//     const [festivalInfos, setFestivalInfos] = useState(data);
//     const navigation = useNavigation();
...
//                         </Text>
//                         <View style={FestivalListStyle.firstLine_right}>
//                             <Image source={require("../../assets/heart.png")} style={FestivalListStyle.likeIcon} />
//                             <Text style={FestivalListStyle.likeCount}>{item.likeCount}</Text>
//                         </View>
//                     </View>
//                     <View style={FestivalListStyle.secondLine}>
