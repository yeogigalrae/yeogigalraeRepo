...
export default FestivalSearchScreen = ({route}) => {
  ...
  return (
    <SafeAreaView style={{backgroundColor: appStyle.APP_MAIN_COLOR}}>
      <View style={FestivalSearchScreenStyle.festivalSearchScreen}>
        <FestivalSearchScreenTop top={route.params?.top} getFestivals={getFestivalList} />
        {festivalList ? (
          <>
          ...
          <View style={{justifyContent: "center", alignItems: "center", height: "80%"}}>
            <ActivityIndicator size="large" color={appStyle.APP_MAIN_COLOR} animating={true} />
          </View>
        )}
      </View>
    </SafeAreaView>
